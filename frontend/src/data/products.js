...
This is expression — under control.`,
  ...
  herEternalReign: {
    ...
    imageUrl: "https://customer-assets-jt897jd0.emergentagent.net/job_0967ced5-e732-403d-b891-6f292f5aebbc/artifacts/ssxu0m5c_1000170739.png",
    shopCardImage: "https://customer-assets-jt897jd0.emergentagent.net/job_0967ced5-e732-403d-b891-6f292f5aebbc/artifacts/ssxu0m5c_1000170739.png",
    dynamicPricing: false,
...
// ────────────────────────────────────────────────────────────────────────────────
// CATALOG (Shop grid) — single source of truth for the /shop card list.
// Each entry holds the lightweight card surface (image, href, price_range,
// inventory, category, audience). Deep product data (pricing tiers, story,
// tributes, dynamic pricing) lives in the `products` object above.
//
// To add a new product to the shop grid: append one entry here. Detail-page
// data lives separately in the `products` object — they are joined by `slug`.
// ────────────────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────────
// ROUGE SIREN — Product #3 of 6. WORKING NAME (formerly VOLUTA) · placeholder
// metadata only. Merchant-approved provisional retail: $6,995 CAD
// (complete earring + anklet set). Solid 10K Rose Gold. Anklet 25 cm / 9.8 in.
// Matching pair earrings. NOT wired into the trusted backend catalog, NOT
// included in `catalogProducts`, NOT surfaced on the homepage carousel,
// Collective, or Ladies grids. Trusted-product count remains 84 until final
// CAD weight + medallion dimensions + clasp are confirmed and merchant
// re-approves the retail price.
// ─────────────────────────────────────────────────────────────────────────
export const rougeSirenPlaceholder = {
  id: 'rouge-siren',
  slug: 'rouge-siren',
  ...
  gallery: [
    ...
    'https://customer-assets-jt897jd0.emergentagent.net/job_0967ced5-e732-403d-b891-6f292f5aebbc/artifacts/d53p1y31_1000171117.png',
...
export const catalogProducts = [
  ...
  { id: 'gravite', name: 'GRAVITÉ', slug: 'gravite',
    ...
    price_range: 'FROM $4,395 USD', inventory_count: 0, is_core: true,
    category: ['rings'],
  ...
  { id: 'la-marva', name: 'La Marva', slug: 'la-marva', materialLine: 'Signature Ring · Dynamic Pricing', imageUrl: 'https://customer-assets.emergentagent.com/job_phileon-website/artifacts/m7k7yxis_1000138213.jpg', href: '/products/la-marva', price_range: formatPrice(products.laMarva.basePrice, 'USD'), inventory_count: 100, is_core: true, category: 'rings', audience: 'ladies' },
  { id: 'annie-rose', name: 'Annie Rose', slug: 'annie-rose', materialLine: 'Lab & Natural Diamonds · 10K-18K Gold', imageUrl: 'https://customer-assets.emergentagent.com/job_phileon-website/artifacts/vg64rc4i_1000139387.jpg', href: '/products/annie-rose', price_range: formatPrice(products.annieRose.basePrice, 'USD'), inventory_count: 100, is_core: true, category: 'rings', audience: 'ladies' },
  { id: 'monika-couture', name: 'Monika Couture Earrings', slug: 'monika-couture', materialLine: 'Statement Earrings · Silver & Gold Options', imageUrl: 'https://customer-assets.emergentagent.com/job_phileon-website/artifacts/xkfi3q1b_1000139956.jpg', href: '/products/monika-couture', price_range: formatPrice(products.monikaCouture.basePrice, 'USD'), inventory_count: 100, is_core: true, category: 'earrings', audience: 'ladies' },
  { id: 'katrina-cascata', name: 'Katrina Cascata', slug: 'katrina-cascata', materialLine: 'Tribute Drop Earrings · Vermeil & 10K Yellow Gold', imageUrl: '/katrina-cascata/main.jpg', href: '/katrina-cascata', price_range: 'From $495', inventory_count: 30, is_core: true, is_new: true, category: 'earrings', audience: 'ladies', collection: 'collective' },
  { id: 'alejandra-heels', name: 'Alejandra Heels Earrings', slug: 'alejandra-heels', materialLine: 'Statement Earrings · Silver & Solid Gold', imageUrl: 'https://customer-assets.emergentagent.com/job_luxury-rings-heels/artifacts/0y3jefc5_1000140400.jpg', href: '/products/alejandra-heels', price_range: formatPrice(products.alejandraHeels.basePrice, 'USD'), inventory_count: 100, is_core: true, category: 'earrings', audience: 'ladies' },
  { id: 'ptp-cuff', name: 'PTP Cuff', slug: 'ptp-cuff', materialLine: 'Cuff Bracelet · Vermeil to 14K Gold', imageUrl: 'https://customer-assets.emergentagent.com/job_7b5a73db-350e-4cc1-ae7d-84976cd8fcfe/artifacts/n1f04383_1000140851.jpg', href: '/products/ptp-cuff', price_range: formatPrice(products.ptpCuff.basePrice, 'USD'), inventory_count: 100, is_core: true, category: 'bracelets', audience: 'gentlemens-club' },
  { id: 'rosaria', name: 'Rosaria Earrings', slug: 'rosaria', materialLine: products.rosaria.shopMaterialLine, imageUrl: 'https://customer-assets.emergentagent.com/job_7b5a73db-350e-4cc1-ae7d-84976cd8fcfe/artifacts/d15gu165_VideoCapture_20260312-012448.jpg', href: '/products/rosaria', price_range: formatPrice(products.rosaria.basePrice, 'USD'), inventory_count: 100, is_core: true, category: 'earrings', audience: 'ladies' },
  { id: 'desir-corset', name: 'Désir Corset Pendant', slug: 'desir-corset', materialLine: products.desirCorset.shopMaterialLine, imageUrl: 'https://customer-assets.emergentagent.com/job_10f60fcd-389e-4787-8e2a-17abd2536e3c/artifacts/sxr71rsz_1000141578.jpg', href: '/products/desir-corset', price_range: formatPrice(products.desirCorset.basePrice, 'USD'), inventory_count: 100, is_core: true, category: 'pendants', audience: 'ladies' },
  { id: 'forme-cuff', name: 'Forme Cuff', slug: 'forme-cuff', materialLine: 'Cuff Bracelet · 10K Gold & Plated Silver', imageUrl: 'https://customer-assets.emergentagent.com/job_cce20d39-4135-43eb-82e5-c299fc05cf79/artifacts/k7kbqg47_1000142846.png', href: '/products/forme-cuff', price_range: formatPrice(products.formeCuff.basePrice, 'USD'), inventory_count: 100, is_core: true, category: 'bracelets', audience: 'ladies' },
  { id: 'rhythm-mesh-ring', name: 'Rhythm Mesh™ Ring', slug: 'rhythm-mesh-ring', materialLine: products.rhythmMeshRing.shopMaterialLine, imageUrl: 'https://customer-assets.emergentagent.com/job_b18523eb-3184-4ba4-8ef3-cdebf4fafd5f/artifacts/nl2vulxg_1000143088.jpg', href: '/products/rhythm-mesh-ring', price_range: formatPrice(products.rhythmMeshRing.basePrice, 'USD'), inventory_count: 100, is_core: true, category: 'rings', audience: 'unisex', audienceImages: { ladies: 'https://customer-assets.emergentagent.com/job_b18523eb-3184-4ba4-8ef3-cdebf4fafd5f/artifacts/skzja828_1000143123.png', gentlemensClub: 'https://customer-assets.emergentagent.com/job_b18523eb-3184-4ba4-8ef3-cdebf4fafd5f/artifacts/dptf24st_1000143315.png' } },
  { id: 'tola-ii', name: 'TOLA II', slug: 'tola-ii', materialLine: products.tolaII.shopMaterialLine, imageUrl: 'https://customer-assets.emergentagent.com/job_a9b887c5-7209-4e2a-b5af-4d14326b755d/artifacts/rst0mhem_1000143383.png', href: '/products/tola-ii', price_range: formatPrice(products.tolaII.basePrice, 'USD'), inventory_count: 100, is_core: true, category: 'rings', audience: 'gentlemens-club' },
  { id: 'galatians-614', name: 'GALATIANS 6:14', slug: 'galatians-614', materialLine: products.galatians614.shopMaterialLine, imageUrl: 'https://customer-assets.emergentagent.com/job_a9b887c5-7209-4e2a-b5af-4d14326b755d/artifacts/tf1ne9cg_1000143695.jpg', href: '/products/galatians-614', price_range: formatPrice(products.galatians614.basePrice, 'USD'), inventory_count: 100, is_core: true, category: 'pendants', audience: 'gentlemens-club' },
  { id: 'trace', name: 'TRACE', slug: 'trace', materialLine: products.trace.shopMaterialLine, imageUrl: 'https://customer-assets.emergentagent.com/job_a9b887c5-7209-4e2a-b5af-4d14326b755d/artifacts/7tyc41kp_1000143768.png', href: '/products/trace', price_range: formatPrice(products.trace.basePrice, 'USD'), inventory_count: 100, is_core: true, category: 'earrings', audience: 'ladies' },
  { id: 'bound', name: 'BOUND', slug: 'bound', materialLine: products.bound.shopMaterialLine, imageUrl: 'https://customer-assets.emergentagent.com/job_a9b887c5-7209-4e2a-b5af-4d14326b755d/artifacts/dxi7r360_1000143892.png', href: '/products/bound', price_range: formatPrice(products.bound.basePrice, 'USD'), inventory_count: 100, is_core: true, category: 'bracelets', audience: 'ladies' },
  { id: 'apex', name: 'APEX', slug: 'apex', materialLine: products.apex.shopMaterialLine, imageUrl: products.apex.imageUrl, href: '/products/apex', price_range: formatPrice(products.apex.basePrice, 'USD'), inventory_count: 100, is_core: true, category: 'earrings', audience: 'ladies' },
  { id: 'homage', name: 'HOMAGE', slug: 'homage', materialLine: 'Fan Earrings · Silver to 18K Gold', imageUrl: products.homage.imageUrl, href: '/products/homage', price_range: products.homage.priceFrom, inventory_count: 100, is_core: true, category: 'earrings', audience: 'ladies' },
  { id: 'cypher', name: 'CYPHER', slug: 'cypher', materialLine: 'Drama on your finger.', imageUrl: products.cypher.gallery[2].src, hoverImage: products.cypher.gallery[1].src, href: '/products/cypher', price_range: products.cypher.priceFrom, inventory_count: 100, is_core: true, category: 'rings', audience: 'gentlemens-club', featured: true },
  { id: 'morso', name: 'IL MORSO DEL RE', slug: 'morso', materialLine: 'The Bite of the King.', imageUrl: products.morso.gallery[2].src, hoverImage: products.morso.gallery[1].src, href: '/products/morso', price_range: products.morso.priceFrom, inventory_count: 100, is_core: true, category: 'rings', audience: 'gentlemens-club', featured: true },
  { id: 'labete', name: 'TRIBUTE: LA BÊTE', slug: 'labete', materialLine: 'Born in the showroom.', imageUrl: products.labete.imageUrl, hoverImage: products.labete.gallery[1].src, href: '/products/labete', price_range: products.labete.priceFrom, inventory_count: 100, is_core: true, category: 'rings', audience: 'gentlemens-club', featured: true },
  { id: 'blessed', name: 'BLESSED', slug: 'blessed', materialLine: 'Word Made Metal.', imageUrl: products.blessed.imageUrl, hoverImage: products.blessed.gallery[1].src, href: '/products/blessed', price_range: products.blessed.priceFrom, inventory_count: 100, is_core: true, category: 'rings', audience: ['gentlemens-club', 'ladies', 'collective'], featured: true },
  { id: 'coogi-i', name: 'COOGI I', slug: 'coogi-i', materialLine: 'Chaos, disciplined.', imageUrl: products.coogiI.imageUrl, hoverImage: products.coogiI.gallery[1]?.src, href: '/products/coogi-i', price_range: products.coogiI.priceFrom, inventory_count: 100, is_core: true, category: 'rings', audience: ['gentlemens-club', 'ladies', 'collective'], featured: true },
  { id: 'fondo-curvo', name: 'Fondo Curvo', slug: 'fondo-curvo', materialLine: products.fondoCurvo.shopMaterialLine, imageUrl: products.fondoCurvo.imageUrl, href: '/products/fondo-curvo', price_range: formatPrice(products.fondoCurvo.basePrice, 'USD'), inventory_count: 100, is_core: true, category: 'earrings', audience: ['ladies', 'collective'] },
  { id: 'corinthians-15-14', name: '1 Corinthians 15:14', slug: 'corinthians-15-14', materialLine: products.corinthians1514.shopMaterialLine, imageUrl: products.corinthians1514.imageUrl, href: '/products/corinthians-15-14', price_range: formatPrice(products.corinthians1514.basePrice, 'USD'), inventory_count: 100, is_core: true, category: 'rings', audience: 'ladies' },
  { id: 'drape', name: 'DRAPE', slug: 'drape', materialLine: products.drape.shopMaterialLine, imageUrl: products.drape.imageUrl, hoverImage: products.drape.onBodyImage, href: '/products/drape', price_range: formatPrice(products.drape.basePrice, 'USD'), inventory_count: 100, is_core: true, category: 'pendants', audience: ['ladies', 'collective'], isNew: true, isFeatured: true, displayOrder: 1 },
  { id: 'le-cocktail-de-jessica', name: 'Le Cocktail de Jessica', slug: 'le-cocktail-de-jessica', materialLine: products.cocktailJessica.shopMaterialLine, imageUrl: products.cocktailJessica.imageUrl, hoverImage: products.cocktailJessica.hoverImage, href: '/products/le-cocktail-de-jessica', price_range: products.cocktailJessica.priceFrom, inventory_count: 100, is_core: true, category: 'rings', audience: ['ladies', 'collective'], isNew: true, isFeatured: true, displayOrder: 2 },
  { id: 'prise-de-couronne', name: 'Prise de Couronne', slug: 'prise-de-couronne', materialLine: products.priseDeCouronne.shopMaterialLine, imageUrl: products.priseDeCouronne.imageUrl, href: '/products/prise-de-couronne', price_range: formatPrice(products.priseDeCouronne.basePrice, 'USD'), inventory_count: 100, is_core: true, category: 'rings', audience: ['gentlemens-club', 'collective'], isNew: true, isFeatured: true, displayOrder: 3 },
  { id: 'nervatura', name: 'The Phileon Nervatura', slug: 'nervatura', materialLine: products.nervatura.shopMaterialLine, imageUrl: products.nervatura.imageUrl, href: '/products/nervatura', price_range: products.nervatura.priceFrom, inventory_count: 100, is_core: true, category: 'earrings', audience: ['ladies', 'collective'], isNew: true, isFeatured: true, displayOrder: 4 },
  { id: 'the-don-gorgon', name: 'The Don Gorgon', slug: 'the-don-gorgon', materialLine: products.theDonGorgon.shopMaterialLine, imageUrl: products.theDonGorgon.imageUrl, href: '/products/the-don-gorgon', price_range: products.theDonGorgon.priceFrom, inventory_count: 100, is_core: true, category: 'rings', audience: ['gentlemens-club', 'collective'], isNew: true, isFeatured: true, displayOrder: 5 },
  { id: 'the-grand-dame', name: 'The Grand Dame Cuff', slug: 'the-grand-dame', materialLine: products.theGrandDame.shopMaterialLine, imageUrl: products.theGrandDame.imageUrl, href: '/products/the-grand-dame', price_range: products.theGrandDame.priceFrom, inventory_count: 100, is_core: true, category: 'bracelets', audience: ['ladies'], isNew: true, isFeatured: true, displayOrder: 6 },
  { id: 'the-carapace', name: 'The Carapace', slug: 'the-carapace', materialLine: products.theCarapace.shopMaterialLine, imageUrl: products.theCarapace.imageUrl, href: '/products/the-carapace', price_range: products.theCarapace.priceFrom, inventory_count: 100, is_core: true, category: 'rings', audience: ['ladies', 'gentlemens-club', 'collective'], isNew: true, isFeatured: true, displayOrder: 7 },
  { id: 'midweek', name: 'MIDWEEK', slug: 'midweek', materialLine: products.midweek.shopMaterialLine, imageUrl: products.midweek.imageUrl, href: '/products/midweek', price_range: products.midweek.priceFrom, inventory_count: 100, is_core: true, category: 'bracelets', audience: ['gentlemens-club', 'collective'], isNew: true, isFeatured: true, displayOrder: 8 },
  { id: 'la-madonna', name: 'LA MADONNA', slug: 'la-madonna', materialLine: 'Architectural Gold Mesh · Corset Form', imageUrl: '/images/la-madonna-hand-category.png', href: '/la-madonna', price_range: '$28,500 USD', inventory_count: 100, is_core: true, category: 'bracelets', audience: ['ladies', 'collective'], isNew: true, isFeatured: true, displayOrder: 2 },
  { id: 'la-scarpa-della-regina', name: 'LA SCARPA DELLA REGINA', slug: 'la-scarpa-della-regina', materialLine: '18K Rose Gold · Hand-set Diamond Field · Signature Objects', imageUrl: '/la-scarpa/scarpa-portrait.jpg', href: '/la-scarpa-della-regina', price_range: '$9,000 USD', inventory_count: 100, is_core: true, category: 'pendants', audience: ['ladies'], isNew: true, isFeatured: true, displayOrder: 2 },
  { id: 'bape', name: 'BAPE™', slug: 'bape', materialLine: 'Tribute Series · Multi-stone Signet', imageUrl: '/homage/bape-ring.webp', href: '/homage/bape', price_range: 'From $9,500 USD', inventory_count: 100, is_core: true, category: 'rings', audience: ['gentlemens-club', 'collective'], isNew: true, isFeatured: true, displayOrder: 3, customCard: 'bape' },
  { id: 'lisa', name: 'LISA', slug: 'lisa', materialLine: 'Natural Emerald · 18K White Gold · Two Scale Expressions', imageUrl: '/lisa/lisa-bold-hero.jpg', href: '/lisa', price_range: 'From CAD $6,800', inventory_count: 100, is_core: true, category: 'rings', audience: ['ladies', 'gentlemens-club', 'collective'], tags: ['Ladies', 'Gents', 'Collective', 'Emerald', 'Dome Ring'], isNew: true, isFeatured: true, displayOrder: 4 },
  { id: 'lady-jay', name: 'LADY JAY', slug: 'lady-jay', materialLine: 'Tribute Series · 2026 Season Only · White Gold · Blue Sapphire + White Diamond', imageUrl: '/lady-jay/lady-jay-hero.png', href: '/lady-jay', price_range: 'From $14,500 USD', inventory_count: 100, is_core: true, category: 'rings', audience: ['ladies', 'collective'], tags: ['Ladies', 'Tribute Series', 'Sapphire', 'Diamond', 'Feather Ring', 'Season Only'], isNew: true, isFeatured: true, displayOrder: 5 },
  { id: 'the-true-vine', name: 'THE TRUE VINE', slug: 'the-true-vine', materialLine: 'Sacred Objects · Pendant · Open Mesh Arch · Raised Cross · Vine Relief', imageUrl: '/the-true-vine/the-true-vine-hero.jpg', href: '/the-true-vine', price_range: 'From $1,650 USD', inventory_count: 100, is_core: true, category: 'pendants', audience: ['gentlemens-club', 'collective'], tags: ['Gents', 'Collective', 'Pendant', 'Sacred Objects', 'Yellow Gold', 'Cross'], isNew: true, isFeatured: true, displayOrder: 6 },
  { id: 'porta-aurea', name: 'PORTA AUREA', slug: 'porta-aurea', materialLine: 'Signet Objects · Yellow Gold · Emerald-Cut Ruby · Greek Key Bezel', imageUrl: '/porta-aurea/porta-aurea-hero.jpg', href: '/porta-aurea', price_range: 'From $5,500 USD', inventory_count: 100, is_core: true, category: 'rings', audience: ['gentlemens-club', 'collective'], tags: ['Gents', 'Collective', 'Signet', 'Ring', 'Yellow Gold', 'Ruby'], isNew: true, isFeatured: true, displayOrder: 7 },
  { id: 'coogi-dna-tag', name: 'COOGI DNA TAG', slug: 'coogi-dna-tag', materialLine: 'Tribute Series · Snow & Sand · 10K Gold · Multi-Stone · Diamond Pavé', imageUrl: '/coogi-dna/coogi-dna-hero.png', href: '/coogi-dna-tag', price_range: '$8,500 USD', inventory_count: 100, is_core: true, category: 'pendants', audience: ['gentlemens-club', 'collective'], tags: ['Gents', 'Collective', 'Pendant', 'Tribute Series', 'COOGI', 'Multi-Stone'], isNew: true, isFeatured: true, displayOrder: 8 },
  ...
  { id: 'parabola-heritage', name: 'PARABOLA HERITAGE', slug: 'parabola-heritage', materialLine: 'Heritage Concave Statement Ring · 22mm Face · Sterling Silver → 10K White Gold → 10K Yellow Gold', imageUrl: '/parabola-heritage/img-01-profile.png', href: '/products/parabola-heritage', price_range: 'From $1,250 USD', inventory_count: 100, is_core: true, category: 'rings', audience: ['gentlemens-club', 'collective'], tags: ['Gentleman', "Gentleman's Club", 'Collective', 'Ring', 'Statement', 'Concave', 'Heritage', 'Ruby', 'Emerald', 'Black Diamond', 'Yellow Gold', 'White Gold', 'Sterling'], isNew: true, isFeatured: true, displayOrder: 13 },
  {
    ...
    category: 'rings',
    audience: ['ladies', 'gentlemens-club', 'collective'],
    tags: ['Unisex', 'Fine Jewelry', 'Ring', 'Sapphire', 'Yellow Gold', 'Blue Sapphire', 'Yellow Sapphire', 'Geometric'],
    isNew: true,
    isFeatured: true,
    displayOrder: 0,
    collection: 'signature',
    label: 'PHILEON Fine Jewelry',
    ctaLabel: 'View SCACCO MATTO',
  },
  {
    id: 'architrave',
    name: 'ARCHITRAVE',
    slug: 'architrave',
    materialLine: 'Openwork Drop Earrings · Sterling Silver, 10K & 14K White Gold · 536 Stones Per Pair',
    ...
    tags: ['Ladies', 'Ladies First', 'Fine Jewelry', 'Earrings', 'Openwork', 'White Gold', 'Silver', 'Lab Diamonds', 'CZ'],
    isNew: true,
    isFeatured: true,
    displayOrder: 0,
    collection: 'signature',
  ...
  },
  {
    ...
    materialLine: 'Sterling Silver · High Polish or Matte',
    imageUrl: 'https://customer-assets-jt897jd0.emergentagent.net/job_0967ced5-e732-403d-b891-6f292f5aebbc/artifacts/p0nvtaur_1000168342.png',
    hoverImage: 'https://customer-assets-jt897jd0.emergentagent.net/job_0967ced5-e732-403d-b891-6f292f5aebbc/artifacts/mb9ie3g5_1000168343.png',
    href: '/bajan-joe',
    // One metal, one price — display as flat "$795 USD" (NOT "From $795").
    price_range: '$795 USD',
    inventory_count: 100,
    is_core: true,
    category: 'rings',
    audience: ['gentlemens-club', 'collective'],
    tags: ['Gents', 'Fine Jewelry', 'Ring', 'Signet', 'Sterling Silver', 'Black Spinel', 'Reptile'],
    isNew: true,
    isFeatured: true,
    displayOrder: 0,
    collection: 'signature',
    label: 'PHILEON Fine Jewelry',
    ctaLabel: 'View BAJAN JOE',
    note: 'Sold Individually',
    shortDescription: 'Sterling-silver reptile signet set with a princess-cut black spinel.',
  },
  {
    id: 'quadriga-dominus',
    ...
    category: 'rings',
    audience: ['gentlemens-club', 'collective'],
    tags: ['Gents', 'Fine Jewelry', 'Ring', 'Statement', 'Pavé', '10K', '14K', 'Genuine Stones'],
    isNew: true,
    isFeatured: true,
    displayOrder: 0,
    collection: 'signature',
    label: 'PHILEON Fine Jewelry',
    ctaLabel: 'View QUADRIGA DOMINUS',
    note: 'Sold Individually · Made to Order',
    shortDescription: 'Gents statement ring in four genuine-stone colorways. 188 pavé stones plus a centre stone. Available in 10K or 14K.',
  },
  {
    id: 'ribbon-regale-edition',
    name: 'RIBBON REGALE ÉDITION',
    slug: 'ribbon-regale-edition',
    subtitle: 'Sculptural Earrings — Solid Gold',
    materialLine: 'Solid Yellow Gold · Available in 10K, 14K and 18K',
    imageUrl: '/inspiration-vault/gold-theory-ribbon/hero-pair-black.png',
    hoverImage: '/inspiration-vault/gold-theory-ribbon/pair-white.jpg',
    href: '/ribbon-regale-edition',
    price_range: 'From $495 CAD',
    priceCurrency: 'CAD',
    priceFrom: 495,
    inventory_count: 12,
    is_core: true,
    category: 'earrings',
    audience: ['ladies', 'collective'],
    tags: ['Ladies', 'Fine Jewelry', 'Earrings', 'Sculptural', 'Solid Gold', '10K', '14K', '18K', 'Yellow Gold'],
    isNew: true,
    isFeatured: false,
    displayOrder: 1,
    collection: 'signature',
    label: 'PHILEON Fine Jewelry',
    ctaLabel: 'View RIBBON REGALE ÉDITION',
    note: 'Made to Order · Sold as One Pair',
    shortDescription: 'The solid-gold Fine Jewelry expression of the sculptural ribbon earrings. Crafted in solid yellow gold and available in 10K, 14K and 18K.',
  },
  {
    id: 'cresta-nera',
    name: 'CRESTA NERA',
    slug: 'cresta-nera',
    subtitle: 'Black Diamond Granulated Gold Bangle',
    materialLine: '10K or 14K Yellow Gold · Black Diamonds',
    imageUrl: 'https://customer-assets-jt897jd0.emergentagent.net/job_0967ced5-e732-403d-b891-6f292f5aebbc/artifacts/otm0wfwp_1000169382.jpg',
    hoverImage: 'https://customer-assets-jt897jd0.emergentagent.net/job_0967ced5-e732-403d-b891-6f292f5aebbc/artifacts/el5elc8u_1000169400.jpg',
    href: '/cresta-nera',
    price_range: 'From $10,495 USD',
    inventory_count: 20,
    is_core: true,
    ...
    subcategory: 'bangles',
    audience: ['gentlemens-club', 'collective'],
    tags: ['Gents', 'Fine Jewelry', 'Bracelet', 'Bangle', 'Yellow Gold', 'Black Diamond', 'Hinged'],
    isNew: true,
    isFeatured: true,
    mainPageCarousel: true,
    displayOrder: 1,
    collection: 'signature',
    label: 'PHILEON Fine Jewelry',
    ctaLabel: 'View CRESTA NERA',
    note: 'Sold Individually',
    shortDescription: 'Yellow-gold hinged bangle with granulated points and black-diamond pavé triangles.',
  },
  {
    id: 'rebelle',
    name: 'REBELLE',
    slug: 'rebelle',
    materialLine: 'Black Pavé Helix Stiletto Earrings · Sterling Silver, 10K & 14K White Gold · Black Enamel · 264 Stones Per Pair',
    ...
    category: 'earrings',
    audience: ['ladies', 'ladies-first'],
    tags: ['Ladies', 'Ladies First', 'Fine Jewelry', 'Earrings', 'Statement', 'Stiletto', 'Double Helix', 'Black Enamel', 'White Gold', 'Silver', 'Lab Black Diamonds', 'Black CZ'],
    isNew: true,
    isFeatured: true,
    soldAs: 'pair',
    displayOrder: 1,
...
// Example: getCatalogList({ category: 'rings', audience: 'ladies' })
export const getCatalogList = (filter = {}) => {
