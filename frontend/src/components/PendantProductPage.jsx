/* =====================================
   PHILEON — REUSABLE PENDANT PRODUCT PAGE
   Use this component for ALL pendant pages.
   NO size selector (pendants don't require sizing)
   ===================================== */
    ...
    <div className="bg-black text-white min-h-screen" data-testid={`${product.id}-page`}>
      <div className="max-w-7xl mx-auto px-4 py-8 grid lg:grid-cols-[1.2fr_0.8fr] gap-10">
        ...
        <div className="lg:sticky lg:top-24 self-start">
          ...
          {product.subline && (
            <p className="text-[#7a7a7a] text-sm tracking-wide mb-6">
              {product.subline}
            </p>
          )}
          ...
          {/* ADD TO CART — No size required for pendants */}
          <button
            disabled={isAdding}
            onClick={onAddToCart}
