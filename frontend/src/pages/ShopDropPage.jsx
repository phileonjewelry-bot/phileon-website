...
const CORE_PRODUCTS = [
  ...
  },
  {
    ...
    name: 'LISA SMALL',
    slug: 'lisa-small',
    materialLine: 'Tighter saturation. Softer pressure.',
    imageUrl: '/lisa/lisa-bold-hero.jpg',
    href: '/ladies/rings/lisa-small',
    price_range: 'Starting at CAD $6,800',
    inventory_count: 100,
    is_core: true,
    category: 'rings',
    audience: ['ladies', 'collective'],
  ...
  },
  {
    ...
    name: 'LISA BOLD',
    slug: 'lisa-bold',
    materialLine: 'Weight without aggression.',
    imageUrl: '/lisa/lisa-bold-hero.jpg',
    href: '/gents/rings/lisa-bold',
    price_range: 'Starting at CAD $10,800',
    inventory_count: 100,
    is_core: true,
    category: 'rings',
    audience: ['gentlemens-club', 'collective'],
