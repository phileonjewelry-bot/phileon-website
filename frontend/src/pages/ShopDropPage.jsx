...
const CORE_PRODUCTS = [
  ...
  },
  {
    ...
    name: 'Fondo Curvo',
    slug: 'fondo-curvo',
    materialLine: 'Statement Earrings · Silver / 10K White Gold',
    imageUrl: products.fondoCurvo.imageUrl,
    href: '/products/fondo-curvo',
    price_range: formatPrice(products.fondoCurvo.basePrice, 'CAD'),
    inventory_count: 100,
    is_core: true,
    category: 'earrings',
    audience: 'ladies',
  ...
  },
  {
    ...
    name: 'DRAPE',
    slug: 'drape',
    materialLine: 'Sculptural Pendant · Silver / 10K / 14K / 18K Rose Gold',
    imageUrl: products.drape.imageUrl,
    hoverImage: products.drape.onBodyImage,
    href: '/products/drape',
    price_range: formatPrice(products.drape.basePrice, 'CAD'),
    inventory_count: 100,
    is_core: true,
    category: 'pendants',
  ...
  },
  {
    ...
    materialLine: 'Cocktail Ring · 10K Tri-Colour Gold · Natural Stones',
