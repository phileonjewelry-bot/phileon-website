/* =========================
   PHILEON MOBILE DROP PAGE (MOBILE ONLY SURPRISE DROP)
   ========================= */
...
function UnlockGlitchHero({ src, alt }) {
  ...
  return (
    <div style={styles.heroMedia} onClick={trigger}>
      <img 
...
/* ===== Mobile Drop Page Component ===== */
export default function MobileDropPage() {
  ...
  if (!isMobile) {
    return (
      <main style={styles.baseWrap} data-testid="mdrop-desktop-fallback">
        <SketchbookBG />
        <div style={styles.card}>
          <h1 style={styles.title}>This drop is mobile-only.</h1>
          <p style={styles.sub}>Open on your phone to unlock it.</p>
          <Link to="/drop" style={styles.cta}>Go to desktop drop</Link>
        </div>
  ...
  return (
    <main style={styles.baseWrap} data-testid="mdrop-mobile">
      <SketchbookBG />

      {/* Top bar */}
      <header style={{ ...styles.topBar, padding: "18px 18px 0" }}>
        ...
        <span style={styles.micro}>MOBILE DROP — UNLOCKED</span>
      </header>

      {/* Hero */}
      <section style={{ ...styles.hero, padding: "18px" }}>
        <div style={{ ...styles.heroFrame, maxWidth: 520 }}>
          <UnlockGlitchHero
            src="/images/drop-001-mobile.png"
            alt="Phileon Mobile Drop"
          />

          <div style={styles.captionWrap}>
            <div style={styles.goldLine} />
            <p style={styles.caption}>
              Tap the piece to "scan". Electric-blue unlock effects are ONLY here.
            </p>
          </div>

          <div style={{ ...styles.actions, flexDirection: "column" }}>
