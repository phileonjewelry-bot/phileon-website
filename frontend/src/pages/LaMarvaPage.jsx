...
const TIERS = [
  {
    ...
    material: "10K Gold",
    price: "$3,400",
    note: "Entry luxury. Visual design identical to higher tiers.",
    highlight: false,
    isHeirloom: false,
    specs: [
      "Precision-cut simulated center stones",
      "Synthetic pink sapphire pavé",
      "High-polish luxury finish",
    ],
  ...
  },
  {
    ...
    material: "14K Gold",
    price: "$5,200",
    note: "Modern luxury with ethical sourcing.",
    highlight: true,
    isHeirloom: false,
    specs: [
    ...
    diamondQuality: "VS clarity, F–G color equivalent",
  },
  {
    name: "Heirloom — Natural Diamond Edition (14K)",
    material: "14K Gold",
    price: "$56,000",
    note: "Collector-grade fine jewelry.",
    highlight: false,
    isHeirloom: true,
    specs: [
      "Natural princess-cut center diamonds",
      "Natural emerald-cut side diamonds",
      "Pink sapphire and diamond pavé",
    ],
    caratWeight: "Approx. 4.5 – 5.5 carats",
    diamondQuality: "VS–SI clarity, G–H color",
  },
  {
