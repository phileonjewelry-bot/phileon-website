...
lower figure count to shave the price.
"""
import pytest
...
@pytest.mark.parametrize("size, tier, figures, expected_cents, sku", [
    # 17 figures
    ("US 6",   "10k", 17,  699500, "HER-10K-F17-SZ6"),
    ("US 6.5", "14k", 17,  899500, "HER-14K-F17-SZ6-5"),
    ("US 7",   "10k", 17,  699500, "HER-10K-F17-SZ7"),
    ("US 7",   "14k", 17,  899500, "HER-14K-F17-SZ7"),
    ("US 7",   "18k", 17, 1049500, "HER-18K-F17-SZ7"),
    # 18 figures (+1)
    ("US 7.5", "10k", 18,  729500, "HER-10K-F18-SZ7-5"),
    ("US 8",   "10k", 18,  729500, "HER-10K-F18-SZ8"),
    ("US 8",   "14k", 18,  934500, "HER-14K-F18-SZ8"),
    ("US 8",   "18k", 18, 1089500, "HER-18K-F18-SZ8"),
    # 19 figures (+2)
    ("US 8.5", "18k", 19, 1129500, "HER-18K-F19-SZ8-5"),
    ("US 9",   "10k", 19,  759500, "HER-10K-F19-SZ9"),
    ("US 9",   "14k", 19,  969500, "HER-14K-F19-SZ9"),
    ("US 9",   "18k", 19, 1129500, "HER-18K-F19-SZ9"),
    # 20 figures (+3)
    ("US 9.5", "14k", 20, 1004500, "HER-14K-F20-SZ9-5"),
    ("US 10",  "10k", 20,  789500, "HER-10K-F20-SZ10"),
    ("US 10",  "14k", 20, 1004500, "HER-14K-F20-SZ10"),
    ("US 10",  "18k", 20, 1169500, "HER-18K-F20-SZ10"),
])
...
def test_client_price_ignored():
    ...
    assert r["unit_amount_cents"] == 1169500
...
def test_figure_count_is_derived_server_side():
    ...
    assert r["unit_amount_cents"] == 789500  # base $6,995 + 3×$300 = $7,895


# ────────────────────────  Mixed currency  ─────
def test_mixed_currency_her_cad_plus_bajan_joe_usd_rejected():
